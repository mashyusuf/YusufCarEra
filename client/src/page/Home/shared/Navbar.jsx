      ...
      {isOpen && (
        <div ref={dropdownRef} className='absolute rounded-xl shadow-md w-[60vw] md:w-[20vw] bg-white overflow-hidden right-0 top-12 text-sm'>
          <div className='flex flex-col cursor-pointer'>
            <Link
              to='/'
              className='block px-4 py-3 hover:bg-neutral-100 transition font-semibold flex items-center gap-2'
            >
            ...
            {user ? (
              <div
                onClick={logOut}
                className='px-4 py-3 hover:bg-neutral-100 transition font-semibold flex items-center gap-2 cursor-pointer'
              >
